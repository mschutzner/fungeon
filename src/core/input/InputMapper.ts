...
export const DEFAULT_MOBILE_MAPPING: Record<string, MobileInputType> = {
  ...
  d_up: MobileInputType.D_UP,
  d_down: MobileInputType.D_DOWN,
  d_left: MobileInputType.D_LEFT,
  d_right: MobileInputType.D_RIGHT,
  minus: MobileInputType.BUTTON_MINUS,
  plus: MobileInputType.BUTTON_PLUS,
...
const ACTION_TO_EVENT: Record<string, GameInputEventType> = {
  ...
  d_up: GameInputEventType.D_UP,
  d_down: GameInputEventType.D_DOWN,
  d_left: GameInputEventType.D_LEFT,
  d_right: GameInputEventType.D_RIGHT,
  minus: GameInputEventType.MINUS,
  plus: GameInputEventType.PLUS,
